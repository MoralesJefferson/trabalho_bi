...
CREATE SCHEMA IF NOT EXISTS `newSakila` DEFAULT CHARACTER SET utf8 ;
USE `newSakila` ;
...
CREATE TABLE DIM_TEMPO (
    ...
    trimestre INT,
    mes VARCHAR(75),
    dia_da_semana VARCHAR(75),
    flag_feriado BOOLEAN
);

CREATE TABLE DIM_CLIENTE (
    id_cliente INT PRIMARY KEY,
    nm_completo_cliente VARCHAR(180),
    ie_sexo CHAR(1),
...
CREATE TABLE DIM_FILME (
    ...
    ds_categoria_principal VARCHAR(40),
    ds_categoria_secundaria VARCHAR(40),
    ds_idioma CHAR(35),
...
CREATE TABLE DIM_FUNCIONARIO (
    ...
    nm_completo_funcionario VARCHAR(170)
);
